...
def drawLine(xList, yList, resultFile, legends = None, xLabel = None, yLabel = None, title = None, colorList = None, opacity = 0.6, xRange = None, yRange = None, marker = "o"):
  ...
  axis.tick_params(axis = "both", top = "off", right = "off" )
  #plot lines
  lineObjList = []
  ...
  if legends is not None:
    plt.legend(lineObjList, legends, fontsize = legendSize, bbox_to_anchor=(0.55, 0.9),bbox_transform=plt.gcf().transFigure)
  #save to file
...
if __name__ == "__main__":
  ...
  xLabel = "Test No"
  yLabel = "Delta(Seconds)"
  drawLine([xList, xList], [y1List, y2List], resultFile = resultFile, legends = legends, xLabel = xLabel, yLabel = yLabel, colorList = availableColorList[:2],xRange = (0, 21), yRange = (0, 300))
