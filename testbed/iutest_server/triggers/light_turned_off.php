<?php
$basicDeviceType = "light";
$basicDeviceState = 1;
$basicTriggerFieldName = "which_light_is_turned_off";
$fKey = "fieldName";
$oKey = "operation";
include "../init.php";
...
if (!array_key_exists($fKey, $_GET) or !array_key_exists($oKey, $_GET)) {
  ...
  #  	"meta" => [
  #  	  #"id" => $uuid,
  #  	  "id" => "sh_trigger_589a116977c86",
  #  	  #"timestamp" => $timestamp,
  #  	  "timestamp" => "1486492009",
  #  	],
  #    ),
  #    array(
  #  	//"CreatedAt" => $isoDateStr,
  #  	"created_at" => "2017-02-07T12:26:49-05:00",
  #  	"the_light_turned_on" => "light 1",
  #  	"meta" => [
  #  	  #"id" => $uuid,
  #  	  "id" => "sh_trigger_589a116977c85",
  #  	  #"timestamp" => $timestamp,
  #  	  "timestamp" => "1486492001",
  #  	],
  #    ),
  #    array(
  #  	//"CreatedAt" => $isoDateStr,
  #  	"created_at" => "2017-02-07T11:26:49-05:00",
  #  	"the_light_turned_on" => "light 1",
  #  	"meta" => [
  #  	  #"id" => $uuid,
  #  	  "id" => "sh_trigger_589a116977c84",
  #  	  #"timestamp" => $timestamp,
  #  	  "timestamp" => "1486492000",
  #  	],
  #    ),
  #);
  #$subItemList = array_slice($triggerItemList, 0, $limit);
  $resultData = array(
